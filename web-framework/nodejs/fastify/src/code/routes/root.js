...
module.exports = async function (fastify, opts) {
  fastify.get('/', async function (request, reply) {
    ...
    <div class="header">
      ...
      <div>
        <a href="https://github.com/devsapp/start-web-framework/tree/master/web-framework/nodejs/fastify/src" target="_blank">
      ...
      <div class="content">
        <div class="list">
          <div class="item">
            ...
            <h2>介绍</h2>
            <p>这是一个 <code>fastify</code> 应用示例，可以通过 Serverless Devs 工具将项目一键部署到云开发环境</p>
          </div>
          <div class="item">
            <div class="step">2</div>
            <h2>文档</h2>
            <p>fastify 官方在线文档，参见 <a href="https://fastify.dev/" target="_blank">https://fastify.dev/</a></p>
          </div>
          <div class="item">
            <div class="step">3</div>
            <h2>快速部署一个 fastify 应用</h2>
            <div class="container">
              <div>
                <h3>步骤一. 准备工作</h3>
