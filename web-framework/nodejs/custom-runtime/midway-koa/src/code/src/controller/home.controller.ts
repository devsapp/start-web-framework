    ...
    <div class="content">
        ...
        <div class="item">
            <div class="step">1</div>
                <h2>介绍</h2>
                <p>这是一个 <code>Midway</code> 应用示例，可以通过 Serverless Devs 工具将项目一键部署到云开发环境</p>
            </div>
        <div class="item">
            <div class="step">2</div>
            <h2>文档</h2>
            <p>Midway 官方在线文档，参见 <a href="https://midwayjs.org/docs/intro" target="_blank">https://midwayjs.org/docs/intro</a></p>
        </div>
        <div class="item">
