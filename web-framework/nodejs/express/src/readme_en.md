...
- [:octocat: source](https://github.com/devsapp/start-web-framework/tree/master/web-framework/nodejs/express/src)
...
- Initialize the project: `s init start-express -d start-express`
...
- Enter the project: `cd start-express`
