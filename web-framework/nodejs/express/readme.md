...
> 快速部署和体验Serverless架构下的 Express.js 项目
...
- [:octocat: 源代码](https://github.com/devsapp/start-web-framework/tree/master/web-framework/nodejs/start-express/src)

## 快速部署和体验
### 在线快速体验

- 通过阿里云 **Serverless 应用中心**： 可以点击 [【🚀 部署】](https://fcnext.console.aliyun.com/applications/create?template=start-express) ，按照引导填入参数，快速进行部署和体验。
...
3. 初始化项目：`s init start-express -d start-express`
4. 进入项目并部署：`cd start-express && s deploy`
