...
- [:octocat: source](https://github.com/devsapp/start-web-framework/tree/master/web-framework/nodejs/nuxt-spa/src)
...
- Initialize the project: `s init start-nuxt-spa -d start-nuxt-spa`
...
- Enter the project: `cd start-nuxt-spa`
