...
- [:octocat: source](https://github.com/devsapp/start-web-framework/tree/master/web-framework/nodejs/egg-app/src)
...
- Initialize the project: `s init egg-app -d egg-appt`
