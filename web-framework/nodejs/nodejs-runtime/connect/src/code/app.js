...
app.use((req, res, next) => {
  ...
  <div class="header">
    ...
    <div>
      <a href="https://github.com/devsapp/start-web-framework/tree/master/web-framework/nodejs/nodejs-runtime/nodejs-runtime/hapi/src" target="_blank">
    ...
    <div class="content">
      <div class="list">
        <div class="item">
          ...
          <h2>介绍</h2>
          <p>这是一个 <code>Connect</code> 应用示例，可以通过 Serverless Devs 工具将项目一键部署到云开发环境</p>
        </div>
        <div class="item">
          <div class="step">2</div>
          <h2>文档</h2>
          <p>Connect 官方在线文档，参见 <a
               href="https://github.com/senchalabs/connect" target="_blank">https://github.com/senchalabs/connect</a></p>
        </div>
        <div class="item">
          <div class="step">3</div>
          <h2>快速部署一个 Connect 应用</h2>
          <div class="container">
            <div>
              <h3>步骤一. 准备工作</h3>
