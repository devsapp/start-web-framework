...
class HomeController extends Controller {
  async index() {
    ...
    <div class="header">
      ...
      <div>
        <a href="https://github.com/devsapp/start-web-framework/tree/master/web-framework/nodejs/nodejs-runtime/nodejs-runtime/egg/src" target="_blank">
      ...
      <div class="content">
        <div class="list">
          <div class="item">
            ...
            <h2>介绍</h2>
            <p>这是一个 <code>Egg</code> 应用示例，可以通过 Serverless Devs 工具将项目一键部署到云开发环境</p>
          </div>
          <div class="item">
            <div class="step">2</div>
            <h2>文档</h2>
            <p>Egg 官方在线文档，参见 <a
                 href="https://eggjs.org/zh-cn/" target="_blank">https://eggjs.org/zh-cn/</a></p>
          </div>
          <div class="item">
