  ...
  <body>
    <header>
      <div class="header">
        ...
        <div>
          <a href="https://github.com/devsapp/nodejs-runtime-framework-application/tree/master/connect-app/src" target="_blank">
    ...
    <div class="content">
      <div class="list">
        <div class="item">
          ...
          <h2>介绍</h2>
          <p>这是一个 <code>Connect</code> 应用示例，可以通过 <code>Serverless Devs</code> 工具将项目一键部署到云开发环境</p>
        </div>
        <div class="item">
          <div class="step">2</div>
          <h2>文档</h2>
          <p>Connect NPM 包，参见 <a
               href="https://www.npmjs.com/package/connect" target="_blank">https://www.npmjs.com/package/connect/</a>.</p>
        </div>
        <div class="item">
