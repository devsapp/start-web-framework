...
- [:smiley_cat: 代码](https://github.com/devsapp/start-web-framework/blob/master/web-framework/nginx)
...
| 服务/业务 |  权限 |  备注  |
| --- |  --- |   --- |
| 函数计算 | AliyunFCFullAccess |  nginx应用部署到函数计算 |
...
- 通过 [Serverless Devs Cli](https://www.serverless-devs.com/serverless-devs/install) 进行部署：
  ...
  - 初始化项目：`s init --project start-nginx-v3 -d start-nginx-v3`
