...
- [:octocat: source](https://github.com/devsapp/start-web-framework/tree/master/web-framework/python/pyramid/src)
- [:earth_africa: Effect Preview](http://pyramid.web-framework.1583208943291465.cn-shenzhen.fc.devsapp.net/)
...
- Initialize the project: `s init start-pyramid -d start-pyramid`
...
- Enter the project: `cd start-pyramid`
