...
- [:octocat: source](https://github.com/devsapp/start-web-framework/tree/master/web-framework/python/tornado/src)
- [:earth_africa: Effect Preview](http://tornado.web-framework.1583208943291465.cn-shenzhen.fc.devsapp.net/)
...
- Initialize the project: `s init start-tornado -d start-tornado`
...
- Enter the project: `cd start-tornado`
