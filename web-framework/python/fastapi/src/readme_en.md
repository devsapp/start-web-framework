...
- [:octocat: source](https://github.com/devsapp/start-web-framework/tree/master/web-framework/python/fastapi/src)
- [:earth_africa: Effect Preview](http://fastapi.web-framework.1583208943291465.cn-shenzhen.fc.devsapp.net/)
...
- Initialize the project: `s init start-fastapi -d start-fastapi`
...
- Enter the project: `cd start-fastapi`
