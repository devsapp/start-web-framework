...
- [:octocat: source](https://github.com/devsapp/start-web-framework/tree/master/web-framework/python/webpy/src)
- [:earth_africa: Effect Preview](http://webpy.web-framework.1583208943291465.cn-shenzhen.fc.devsapp.net/)
...
- Initialize the project: `s init start-webpy -d start-webpy`
...
- Enter the project: `cd start-webpy`
