...
- [:octocat: source](https://github.com/devsapp/start-web-framework/tree/master/web-framework/php/discuz/src)
- [:earth_africa: Effect Preview](http://discuz.web-framework.1583208943291465.cn-shenzhen.fc.devsapp.net/)
...
- Initialize the project: `s init start-discuz -d start-discuz`
...
- Enter the project: `cd start-discuz`
