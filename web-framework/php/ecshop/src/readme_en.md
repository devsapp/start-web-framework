...
- [:octocat: source](https://github.com/devsapp/start-web-framework/tree/master/web-framework/php/ecshop/src)
- [:earth_africa: Effect Preview](http://ecshop.web-framework.1583208943291465.cn-shenzhen.fc.devsapp.net/)
...
- Initialize the project: `s init start-ecshop -d start-ecshop`
...
- Enter the project: `cd start-ecshop`
