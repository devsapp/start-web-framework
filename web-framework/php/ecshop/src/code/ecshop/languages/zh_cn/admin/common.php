...
$_LANG['prompt_image'] = 'APP提示页设置';
$_LANG['kefu'] = '客服联系电话';
$_LANG['download'] = 'APP下载地址设置';
$_LANG['logo_setting'] = '首页logo设置';
$_LANG['logo_other'] = '首页外logo设置';
$_LANG['keywords'] = '热门搜索设置';
$_LANG['pay_dispose'] = '支付配置';
$_LANG['logistics'] = '物流配置';
$_LANG['index_imgae'] = '首页设置';
$_LANG['default_image'] = 'App默认图片';
$_LANG['copyright_modify'] = '版权设置';
$_LANG['live_settings'] = '直播设置';
$_LANG['apple_login'] = '苹果登录';
