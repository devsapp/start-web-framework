    ...
    if (empty($row['is_separate']))
    {
        ...
        if(empty($separate_by))
        {
            ...
            for ($i=0; $i < $num; $i++)
            {
                ...
                else
                {
                    ...
                    log_account_change($up_uid, $setmoney, 0, $setpoint, 0, $info,'99',$order_sn);
        ...
        else
        {
            ...
            if(!empty($up_uid) && $up_uid > 0)
            {
                ...
                log_account_change($up_uid, $money, 0, $point, 0, $info,'99',$order_sn);
...
function get_affiliate_ck()
{
    ...
    while ($rt = $GLOBALS['db']->fetch_array($query))
    {
        ...
        {
            //在affiliate_log有记录
            $rt['info'] = sprintf($GLOBALS['_LANG']['separate_info2'], $rt['suid'],  urldecode($rt['auser']), $rt['money'], $rt['point']);
