...
//把10月1号到12月1号的订单推送到淘打
//elseif ($_REQUEST['step'] == 'order_push')
//{
//    $status_time = mktime(0,0,0,10,1,2020);
//    $end_time = mktime(0,0,0,12,2,2020);
//    $sql = "SELECT order_sn FROM " . $ecs->table('order_info') . " WHERE add_time >" . $status_time." and add_time<".$end_time;
//    $res = $db->getAll($sql);
//    var_dump($res);die;
//    include_once("includes/cls_matrix.php");
//    $matrix = new matrix();
...
//        if($bind_info){
//            $matrix->createOrder($value['order_sn'],'taodali');
//        }
//    }
//}
