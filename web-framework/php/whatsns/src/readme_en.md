...
- [:octocat: source](https://github.com/devsapp/start-web-framework/tree/master/web-framework/php/whatsns/src)
- [:earth_africa: Effect Preview](http://whatsns.web-framework.1583208943291465.cn-shenzhen.fc.devsapp.net/)
...
- Initialize the project: `s init start-whatsns -d start-whatsns`
...
- Enter the project: `cd start-whatsns`
