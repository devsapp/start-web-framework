...
$lang = array(
	...
	'tips_admininfo_comment' => '请牢记whatsns问答系统创始人密码，凭该密码登陆 ask。',
	...
	'uc_url_empty' => '您没有填写whatsns问答系统的 URL，请返回填写',
	...
	'uc_version_incorrect' => '您的whatsns问答系统服务端版本过低，请升级whatsns问答系统服务端到最新版本，并且升级，下载地址：http://www.whatsns.cn/ 。',
	'config_unwriteable' => '安装向导无法写入配置文件, 请设置 config.inc.php 程序属性为可写状态(777)',

	'install_in_processed' => '正在安装...',
	'install_succeed' => '安装whatsns成功，点击进入下一步',
	'license' => '<div class="license"><h1>中文版授权协议 适用于中文用户</h1>

<p>版权所有 (c) 2001-2012，whatsns软件开发工作室保留所有权利。</p>

<p>感谢您选择whatsns问答产品。希望我们的努力能为您提供一个高效快速和强大的站点解决方案。</p>

<p>whatsns软件开发工作室为whatsns问答产品的开发商，依法独立拥有whatsns问答系统著作权。whatsns软件开发工作室网址为 http://www.whatsns.cn</p>

<p>whatsns问答系统著作权已在中华人民共和国国家版权局注册，著作权受到法律和国际公约保护。使用者：无论个人或组织、盈利与否、用途如何（包括以学习和研究为目的），均需仔细阅读本协议，在理解、同意、并遵守本协议的全部条款后，方可开始使用whatsns问答系统软件。</p>

<p>本授权协议适用且仅适用于whatsns 3.X版本，whatsns软件开发工作室拥有对本授权协议的最终解释权。</p>

<h3>I. 协议许可的权利</h3>
<ol>
<li>您可以在完全遵守本最终用户授权协议的基础上，将本软件应用于非商业用途，而不必支付软件版权授权费用。</li>
<li>您可以在协议规定的约束和限制范围内修改whatsns问答系统源代码(如果被提供的话)或界面风格以适应您的网站要求。</li>
...
<h3>II. 协议规定的约束和限制</h3>
<ol>
<li>未获商业授权之前，不得将本软件用于商业用途（包括但不限于企业网站、经营性网站、以营利为目或实现盈利的网站）。购买商业授权请登陆http://www.whatsns.cn参考相关说明，也可以致电15911179271了解详情。</li>
<li>不得对本软件或与之关联的商业授权进行出租、出售、抵押或发放子许可证。</li>
<li>无论如何，即无论用途如何、是否经过修改或美化、修改程度如何，只要使用whatsns答系统的整体或任何部分，未经书面许可，页面页脚处的whatsns问答系统名称和whatsns软件开发工作室下属网站（http://www.whatsns.cn ） 的链接都必须保留，而不能清除或修改。</li>
<li>禁止在whatsns问答系统的整体或任何部分基础上以发展任何派生版本、修改版本或第三方版本用于重新分发。</li>
...
<li>whatsns软件开发工作室不对使用本软件构建的网站中的文章或信息承担责任。</li>
</ol>

<p>有关whatsns问答系统最终用户授权协议、商业授权与技术服务的详细内容，均由whatsns问答系统官方网站独家提供。whatsns软件开发工作室拥有在不事先通知的情况下，修改授权协议和服务价目表的权力，修改后的协议或价目表对自改变之日起的新授权用户生效。</p>
