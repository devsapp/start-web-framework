...
<div class="user-home bg-white" style="margin-bottom: 40px">
 ...
 <form name="articleform" class="form-horizontal mar-t-1" action="{url admin_chajian/addarticle}"  method="post" enctype="multipart/form-data" >
    <div class="row main">
                 <div class="col-md-20">
                     <div class="dongtai">
                         <p>
...
<p>封面图:</p>
  ...
  <input type="file" id="layer_upload" onchange="previewImage(this)" name="image" title="点击这选择封面图片，大小建议288px*192px,或者填封面图外部链接" style="opacity: 0;height: 40px;position:relative;top:-2rem;">
   ...
   <div class="col-sm-24" style="margin-bottom: 20px;">
  <span>文章访问量</span>
     <input type="number" name="views" value="100" class="form-control views" style="width:150px;display:inline-block;" placeholder="文章访问量设置">
           次
 </div>
 <div class="add-img-box row" style="margin-bottom: 20px">
  ...
  <span> &nbsp;&nbsp;付费模式:</span>
    ...
    <div class="add-img-box row">
     ...
     <span style="padding-left: 12px;">阅读需要</span>
...
<script type="text/javascript">
     ...
     <input type="text" AUTOCOMPLETE="OFF" id="outimgurl" name="outimgurl" value="{SITE_URL}static/css/dist/css/images/default.jpg" size="350" class="form-control" placeholder="如果不上传可以选择外部封面图片地址">
        ...
        <!-- -待续 -->
          ...
          <div class="form-group">
        <div class=" col-md-20">
            <input type="hidden" name="pubauthor" id="pubauthor" value="{$user['username']}" />
  ...
  <input type="button" id='article_btn' onclick="checkform()" class="btn btn-success width-120" name="postbtn"  value="提 交">
   <input type="button" onclick="getimg()" class="btn btn-default width-120 mar-ly-1" name="postbtn"  value="内容提取封面图">
...
if(result.code==200){
    ...
    document.articleform.action = "{url admin_chajian/addarticle}";
