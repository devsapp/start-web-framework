...
<table class="table">
  ...
  <option value ="gb2312" >gb2312</option>
         ...
         <tr>
            ...
            <td class="altbg2">
              ...
              <option {if $caiji['tiwenshijian']==1} selected  {/if} value="1">1</option>
   <option {if $caiji['tiwenshijian']==2} selected  {/if} value="2">2</option>
     <option {if $caiji['tiwenshijian']==3} selected  {/if} value="3">3</option>
       <option {if $caiji['tiwenshijian']==4} selected  {/if}  value="4">4</option>
         <option {if $caiji['tiwenshijian']==5} selected  {/if}  value="5">5</option>
           <option  {if $caiji['tiwenshijian']==6} selected  {/if} value="6">6</option>
             <option  {if $caiji['tiwenshijian']==7} selected  {/if} value="7">7</option>
               <option  {if $caiji['tiwenshijian']==8} selected  {/if} value="8">8</option>
                 <option  {if $caiji['tiwenshijian']==9} selected  {/if} value="9">9</option>
                   <option  {if $caiji['tiwenshijian']==10} selected  {/if} value="10">10</option>
                     <option  {if $caiji['tiwenshijian']==12} selected  {/if} value="11">11</option>
                       <option  {if $caiji['tiwenshijian']==13} selected  {/if} value="12">12</option>
     ...
     <option  {if $caiji['huidashijian']==30} selected  {/if} value="30">30</option>
       ...
       <tr>
         ...
         <tr>
            ...
            <td class="altbg2">
               <input type="text"  id="caiji_best" class="form-control short-input"  value="{$caiji['caiji_best']}" name="caiji_best" style="width:300px" />
            </td>
        </tr>
  ...
  <option value ="{$activeuser['uid']}" {if $s_username==$activeuser['uid']} selected  {/if}> {$activeuser['username']}</option>
         ...
         <tr>
            ...
            <td class="altbg2">
               <input type="text"  id="caiji_hdusername" class="form-control short-input"  value="{$caiji['caiji_hdusername']}" name="caiji_hdusername" style="width:300px" />
            </td>
        </tr>
         <tr>
            <td class="altbg1" width="45%"><b>回答用户头像采集规则:</b><br>填写用户头像html标签的类名或者ID即可，记得类名加".",ID加"#"</td>
            <td class="altbg2">
               <input type="text"  id="caiji_hdusertx"  class="form-control short-input"  value="{$caiji['caiji_hdusertx']}" name="caiji_hdusertx" style="width:300px" />
            </td>
        </tr>
        <tr>
           ...
           <tr>
            ...
            <input type="checkbox"  {if $caiji['ckabox']==1} checked  {/if}  id="ckabox" name="ckabox" >  <label>过滤回答中的a标签请勾选</label>
            </td>
        </tr>
         <tr>
            ...
            <input type="checkbox"  {if $caiji['imgckabox']==1} checked  {/if}  id="imgckabox" name="imgckabox" >  <label>过滤回答中的img标签请勾选</label>
            </td>
        </tr>
