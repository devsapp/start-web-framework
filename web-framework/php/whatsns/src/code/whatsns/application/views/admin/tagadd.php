...
<form action="{url admin_tag/add}" method="post" enctype="multipart/form-data">
<input type="hidden" name="uid" value="{$member['uid']}" />
			<table class="table">
				<tr class="header">
					...
					<input class="text" value="" id="tagname" name="tagname">(必填，唯一)<span class="tagnamecheck" style="color:red;cursor:pointer;margin-left:10px;">点击标签名称重复冲突检测</span></td>
				</tr>
				<tr>
					<td class="altbg1" width="45%"><b>标签别名(必填):</b><br><span class="smalltxt">英文名称或者拼音，一般不要修改，否则影响seo</span></td>
					<td class="altbg2">
					
					<input class="text" type="text" placeholder="英文/拼音，禁止中文" id="tagalias" name="tagalias" value="">(必填，唯一) <span class="tagaliascheck" style="color:red;;cursor:pointer;margin-left:10px;">点击别名重复冲突检测</span></td>
				</tr>
				<tr>
