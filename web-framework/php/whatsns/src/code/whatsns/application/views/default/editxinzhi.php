...
<div class="user-home bg-white pubarticle" style="margin-bottom: 40px">
         ...
         <div class="form-group">
          ...
          {loop $topic['tags'] $tag}
           ...
           <div class="tagsearch">
                       ...
                       <div class="form-group">
          <p class="col-md-24  text-left fl"><b>文章描述:</b></p>
          <div class="col-md-24 has-error">
 ...
 <div class="col-md-24" style="padding-left: 0px;">
    ...
    <div class="add-img-box row">
     ...
     <span>阅读需要</span>
      <input type="number" AUTOCOMPLETE="OFF" id="topic_price" name="topic_price" value="{$topic['price']}" size="100" class="txt_price" placeholder="可以留空">
           <span>{eval if ($topic['readmode']==2) echo '积分'; }{eval if ($topic['readmode']==3) echo '元'; }</span>
     </div>
...
$("#article_btn").click(function(){
	...
	var _topic_price=$("#topic_price").val();
        ...
        if(freeconentval==''&&parseInt(_topic_price)>0){
	    	   alert("付费阅读试看内容不能为空");
	  		 return false;
	       }
	 if(v==''){
