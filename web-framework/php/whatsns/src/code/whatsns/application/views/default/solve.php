...
<div class="advlong-bottom">
	<div class="advlong-default">{$adlist['question_view']['inner1']}</div>
</div>
<!--{/if}-->
<!--{eval $adlist = $this->fromcache("adlist");}-->
<div class="work-details-wrap border-bottom">
	<div class="work-details-box-wrap container">
		...
		<div class="left-details-head col-md-16">
			<div class="works-tag-wrap">
				...
				<a href="{url tags/view/$tag['tagalias']}" title="{$tag['tagname']}"
					target="_blank" class="project-tag-14">{$tag['tagname']}</a>
			...
			<div class="details-contitle-box">
				...
				<h2>
					{$question['title']} {if
					$question['shangjin']&&$question['status']==1}<img
						class="jinxingzhong"
						src="{SITE_URL}static/images/jinxingzhong.png" /> {/if} {if
					$question['shangjin']&&$question['status']==9}<img class="imgjiesu"
						src="{SITE_URL}static/images/yijiesu.png" /> {/if} {if
					$question['price']>0} <span data-toggle="tooltip"
						data-placement="bottom" title=""
						data-original-title="悬赏 {$question['price']}财富值，采纳后可获得"
						class="icon_jifen"><i class="fa fa-database mar-r-03"></i>财富值{$question['price']}</span>
					{/if} {if $question['shangjin']!=0} <span data-toggle="tooltip"				data-placement="bottom" title=""
						data-original-title="如果回答被采纳将获得 {eval echo doubleval ( $this->setting ['weixin_fenceng_zuijia'] )*$question['shangjin'];}元，可提现"
						class="icon_hot"><i class="fa fa-hongbao mar-r-03"></i>悬赏$question['shangjin']元</span>

					{/if} {if $question['hasvoice']!=0} <span data-toggle="tooltip"
						data-placement="bottom" title="" class="icon_green"><i
						class="fa fa-volume-up mar-r-03"></i>语音偷听</span> {/if} {if
					$question['askuid']>0} <span data-toggle="tooltip"
						data-placement="bottom" title=""
						data-original-title="邀请{$question['askuser']['username']}回答"
						class="icon_zise"><i class="fa fa-twitch mar-r-03"></i>邀请回答</span>
					{/if} {if $question['status']!=9} {if $showtime} <span
						data-toggle="tooltip" data-placement="bottom" title=""
						data-original-title="超过时间没有采纳，系统将自动分配最佳答案，没有回答赏金自动返回给作者"
						class="time-item hide"> 【<span id="day_show">0天</span> <strong
						id="hour_show">0时</strong> <strong id="minute_show">0分</strong> <strong
						id="second_show">0秒</strong>】
					</span>
					<script>
		...
		$(".time-item").removeClass("hide").css("color","#ea644a").show()
				...
				<p class="title-time">
					...
					<span>{$question['format_time']}</span>发布 <span class="share-group">
						...
						href="javascript:void((function(s,d,e,r,l,p,t,z,c){var%20f='http://v.t.sina.com.cn/share/share.php?appkey=1515056452',u=z||d.location,p=['&amp;url=',e(u),'&amp;title=',e(t||d.title),'&amp;source=',e(r),'&amp;sourceUrl=',e(l),'&amp;content=',c||'gb2312','&amp;pic=',e(p||'')].join('');function%20a(){if(!window.open([f,p].join(''),'mb',['toolbar=0,status=0,resizable=1,width=440,height=430,left=',(s.width-440)/2,',top=',(s.height-430)/2].join('')))u.href=[f,p].join('');};if(/Firefox/.test(navigator.userAgent))setTimeout(a,0);else%20a();})(screen,document,encodeURIComponent,'','','{$setting['site_logo']}', '推荐 {$question['author']} 的问题《{$question['title']}》','{url question/view/$question[id]}','页面编码gb2312|utf-8默认gb2312'));"
  ...
  function shareqq()
  {
      var p = {
          ...
          desc: " {eval    $str=  clearhtml(replacewords(htmlspecialchars_decode(htmlspecialchars_decode($question['description']))),50);  echo   $str; }", 
      ...
      window.open(target_url, 'qq',
              'height=520, width=720');
				...
				<div class="work-head-box">
					<div class="head-left">
						<span class="head-index"> <span><a href="{url ask/index}"
								target="_blank">站内问答</a></span> <i>/</i> <span> <a
								class="notebook"
								href="{eval echo getcaturl($question['cid'],'category/view/#id#');}"
								data-toggle="tooltip" data-html="true"
								data-original-title="问题归属分类"> <span>{$question['category_name']}</span>
							</a>
						</span>
					...
					<div class="head-right">
						<span class="head-data-show"> <a href="javascript:;"
							title="共{$question['views']}人气" class="see vertical-line"> <i></i>{$question['views']}
						</a> <a href="javascript:;" title="共{$question['answers']}回答"
							class="news vertical-line"> <i></i>{$question['answers']}
						</a> <a href="javascript:;" title="共 {$question['attentions']}收藏"
							class="recommend-show"> <i></i> {$question['attentions']}
						</a>
						</span>
						<!-- cdn节点 问题操作 -->
	...
	<div class="container ">
		...
		<div class="content-wrap">
			<div class="left-details-head qs" style="border: none">
				...
				<div class="show-content  ">{eval echo replacewords($question['description']);}
			...
			<div class="details-con-other border-top"
				{if !$question['description']} style="margin-top: 0px;"{/if}>
				<div class="">
    ...
    <strong>友情提示:</strong> 此问题总悬赏金额:<span class="text-red"><b>{$question['shangjin']}元</b></span>,被采纳答案的答主将获得<span class="text-red"><b>{eval echo doubleval ( $this->setting ['weixin_fenceng_zuijia'] )*$question['shangjin'];}元</b></span>
  ,其它回答的答主将平分剩余金额<span class="text-red"><b>{eval echo doubleval ( $this->setting ['weixin_fenceng_answerother'] )*$question['shangjin'];}元</b></span> ,平台获得<span class="text-red"><b>{eval echo doubleval ( $this->setting ['weixin_fenceng_answersite'] )*$question['shangjin'];}元</b></span>
  {if isset($setting['xuanshang_question_answers'])&&$setting['xuanshang_question_answers']!=0}，最多参与回答人数<span class="text-red"><b>$setting['xuanshang_question_answers']人</b></span>{/if}。</div>
				{/if}
...
<div class="container index" id="showanswerform">
	<div class="row">
		<div class="col-md-17 main " style="padding: 0px;">
					...
					<!-- 是否开启了只允许指定专家回答-对于一对一咨询问题 -->
						...
						<div class="new-comment canwirteanswer"
							...
							<div style="" class="answer-txtbox bb top-answer"
								...
								{if isset($cananswerthisquestion)&&$cananswerthisquestion==false}
								<div class="c-text alert alert-success-inverse">
									<i class="fa fa-info-circle mar-ly-1"></i>该问题只允许用户【{$question['askuser']['username']}】回答！
								</div>
								{else}
								
								<form class="new-comment" id="huidaform" name="answerForm"
									method="post" style="margin: 10px;">
									<input type="hidden" value="{$question['id']}" id="ans_qid"
										name="qid"> <input type="hidden" id="tokenkey" name="tokenkey"
										value='{$_SESSION["answertoken"]}' /> <input type="hidden"
										value="{$question['title']}" id="ans_title" name="title">
									...
									<div class="write-function-block">
										...
										{/if} <a class="btn btn-send" id="ajaxsubmitasnwer">发送</a>
									</div>

									<!--{if $setting['code_ask']&&$user['credit1']<$setting['jingyan']}-->
									<div class="write-function-block ">{template code}</div>
									<!--{/if}-->
								</form>
							{/if}
							...
							<div id="normal-comment-list" class="normal-comment-list">
								<div>
									...
									<div id="comment-{$bestanswer['id']}" class="comment">
										...
										<div>
											{if
											$question['authorid']==$bestanswer['authorid']&&$question['hidden']==1}
											<div class="author">
												<a href="javascript:" class="avatar"> <img
													src="{SITE_URL}static/css/default/avatar.gif">
												</a>
												<div class="info">
													<a href="javascript:" class="name"> 匿名用户 </a>
													<!---->
													<div class="meta">
														<span>1楼 · {$bestanswer['format_time']}.<span
															class="text-danger"><i class="fa fa-check"></i>采纳回答</span></span>
															{if $question['shangjin']>0}<span class="label label-danger" data-toggle="tooltip"	data-placement="bottom" title=""	data-original-title="任务悬赏问题，答主被采纳获得佣金">获得作者{if isset($bestanswer['commission'])&&$bestanswer['commission']!=0}{eval echo floatval($bestanswer['commission']);}{else}{eval echo doubleval ( $this->setting ['weixin_fenceng_zuijia'] )*$question['shangjin'];}{/if}元分成</span>{/if}
													</div>
												</div>
											</div>
											{else}
											<div class="author">
												<a href="{url user/space/$bestanswer['authorid']}"
													...
													src="{$bestanswer['author_avartar']}">
												</a>
												<div class="info">
													<a href="{url user/space/$bestanswer['authorid']}"
														target="_self" class="name"> {$bestanswer['author']} {if
														$bestanswer['author_has_vertify']!=false}<i
														class="fa fa-vimeo {if $bestanswer['author_has_vertify'][0]=='0'}v_person {else}v_company {/if}  "
														data-toggle="tooltip" data-placement="right" title=""
														{if $bestanswer['author_has_vertify'][0]==
														'0'}data-original-title="个人认证"
														{else}data-original-title="企业认证"{/if} ></i>{/if} {if
														$bestanswer['signature']} <span class="signature">-
															$bestanswer['signature']</span> {/if}
													</a>
													<!---->
													<div class="meta">
														<span>1楼 · {$bestanswer['format_time']}.<span
											...
											<div class="comment-wrap art-content">
												<div class="answercontent" style="max-height:20000px">
													{if $bestanswer['serverid']==null} {if
													$bestanswer['reward']==0||$bestanswer['authorid']==$user['uid']}
													...
													<div onclick="checkpay($question['id'],$bestanswer['id'])" data-placement="bottom" title=""
															data-toggle="tooltip" data-original-title="我也付费偷偷看"
															class="thiefbox font-12" onclick="">
															<i class="icon icon-lock font-12"></i>
															&nbsp;精彩回答&nbsp;$bestanswer['reward']&nbsp;&nbsp;元偷偷看…… <span
																class="kanguoperson">$bestanswer['viewnum']人看过</span>
														</div>

													</div>
													{else} {eval echo replacewords($bestanswer['content']);}
													
													 {/if} {/if} {else}

													<div class="htmlview">
														<div class="yuyinplay" id="{$bestanswer['serverid']}">
															<i class="fa fa-volume-up "></i><span class="u-voice"> <span
																class="wtip">免费偷听</span>

																&nbsp;{$bestanswer['voicetime']}秒
															</span>
															<audio id="voiceaudio" width="420" style="display: none">
																<source
																	src="{SITE_URL}data/weixinrecord/{$bestanswer['mediafile']}"
																	type="audio/mpeg" />
													...
													<div class="appendcontent">
														...
														<div class="appendbox">
															...
															<h4 class="appendanswer font-12">
																答主追加回答:<span class="time"> {$bestanswer['format_time']}</span>
															</h4>
															<!--{else}-->
															<h4 class="appendask font-12">
																作者追问:<span class='time'>{$bestanswer['format_time']}</span>
															</h4>
															<!--{/if}-->
										...
										<div class="comments-mod "
											...
											<div class="areabox clearfix">
												...
												<div class="input-group">
													<input type="text" placeholder="请输入评论内容，不少于5个字"
														...
														name="submit" onclick="addcomment({$bestanswer['id']});" />
													</span>
												</div>
											...
											<ul class="my-comments-list nav">
												<li class="loading"><img
													src='{SITE_URL}static/css/default/loading.gif'
            ...
            <!---->
             <div class="meta">
                  {if $bestanswer['id']==null}
             <span>{eval echo $nindex+1;}楼-- · {$answer['time']}</span>
             {else}
       
                <span>{eval echo $nindex+2;}楼-- · {$answer['time']}</span>
             {/if}
              {if $question['shangjin']>0&&isset($answer['commission'])&&$answer['commission']!=0}<span class="label label-danger" data-toggle="tooltip"	data-placement="bottom" title=""	data-original-title="任务悬赏问题，参与回答获得佣金">获得作者{eval echo round(floatval($answer['commission']),2);}元分成</span>{/if}
             </div>
             </div>
             </div>
             {else}
    ...
    <source src="{SITE_URL}data/weixinrecord/{$answer['mediafile']}" type="audio/mpeg" />
             ...
             <!-- cdn节点 回答操作 -->
											...
											<div class="areabox clearfix">
												...
												<div class="input-group">
													<input type="text" placeholder="请输入评论内容，不少于5个字"
														...
														name='replyauthor' /> <span class="input-group-btn"><input
														type="button" value="评论" class="btn btn-green"
														name="submit" onclick="addcomment({$answer['id']});" /> </span>
												</div>
						...
						{if isset($cananswerthisquestion)&&$cananswerthisquestion==true&&$setting['question_expert_answerlimit']==0}
<!-- cdn 问答邀请 -->
...
{/if}		
						...
						<div class="new-answer bb">
							<h3 class="title">
								一周热门 <a href="{url ask/index}" target="_blank" class="more">更多<font>&gt;
								</font></a>
							</h3>
							<div class="inf-list">
								<ul class="clearfix">
									...
									<li><a href="{url question/view/$solve['id']}"
										title="{$solve['title']}">{eval echo clearhtml($solve['title'],22);}
											</a></li>
...
{/if}
						<!--{loop $solvelist $solve}-->
						  {if ($setting['xunsearch_open']) }
  {eval $solve['questionid']=$solve['id'];}
  {/if}
						{if $question['id']!=$solve['questionid']}
						<li class="no-video"><a
							href="{url question/view/$solve['questionid']}"
						"> {eval echo strip_tags($solve['title']);} </a>
							<div class="num-ask">
								<a href="{url question/view/$solve['questionid']}" class="anum">
									{$solve['answers']} 个回答</a>
							</div></li> {/if}
...
{if ($setting['xunsearch_open']) }
{eval $topiclist=$this->topic_model->get_bylikename($question['title'],0,10);}
{/if}

						<!--{loop $topiclist $topic}-->
										  {if ($setting['xunsearch_open']) }
  {eval $topic['articleid']=$topic['id'];}
  {/if}
						<li class="no-video"><a
							href="{url topic/getone/$topic['articleid']}"
							> {eval echo strip_tags($topic['title']);} </a>
							<div class="num-ask">
								<a href="{url topic/getone/$topic['articleid']}"
									title="{$topic['title']}" class="anum">{$topic['articles']}
									个评论</a>
							</div></li>
						<!--{/loop}-->
	...
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-body">
				...
				<div data-url="{url question/view/$question['id']}" class="qrcode"
					title="{url question/view/$question['id']}">
