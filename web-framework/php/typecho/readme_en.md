...
- [:octocat: source](https://github.com/devsapp/start-web-framework/tree/master/web-framework/php/typecho/src)
- [:earth_africa: Effect Preview](http://typecho.web-framework.1583208943291465.cn-shenzhen.fc.devsapp.net/)
...
- Initialize the project: `s init start-typecho -d start-typecho`
...
- Enter the project: `cd start-typecho`
