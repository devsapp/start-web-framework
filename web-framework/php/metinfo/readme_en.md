...
- [:octocat: source](https://github.com/devsapp/start-web-framework/tree/master/web-framework/php/metinfo/src)
- [:earth_africa: Effect Preview](http://metinfo.web-framework.1583208943291465.cn-shenzhen.fc.devsapp.net/)
...
- Initialize the project: `s init start-metinfo -d start-metinfo`
...
- Enter the project: `cd start-metinfo`
