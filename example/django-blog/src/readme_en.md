...
- [:octocat: source](https://github.com/devsapp/start-web-framework/tree/master/example/django-blog/src)
- [:earth_africa: Effect Preview](http://django-blog.web-framework.1583208943291465.cn-shenzhen.fc.devsapp.net/)
...
- Initialize the project: `s init django-blog -d django-blog`
...
- Enter the project: `cd django-blog`
