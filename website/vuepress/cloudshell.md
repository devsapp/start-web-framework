# 快速体验 Vuepress 案例
欢迎您使用Serverless Devs开发者工具进行项目开发，本实验是基于Serverless Devs部署 Vuepress 到阿里云函数计算。
整个实验过程包括：
- [下载工具](#下载工具)
- [配置密钥](#配置密钥)
- [初始化项目](#初始化项目)
...
> - [:earth_africa: 效果预览](http://vuepress.website.1767215449378635.cn-hangzhou.fc.devsapp.net)
...
进行项目初始化：
```
s init website-vuepress -d website-vuepress
```
