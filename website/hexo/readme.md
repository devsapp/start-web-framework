...
- [:octocat: 源代码](https://github.com/devsapp/start-web-framework/tree/master/web-framework/website/hexo/src)
- [:earth_africa: 效果预览](
...
您可以在阿里云 [:earth_asia: Serverless 应用中心](https://fcnext.console.aliyun.com/applications/create?template=website-hexo) ，快速体验该应用：   
...
## 通过阿里云CloudShell部署
如果您不想在应用中心中快速体验，也不想下载命令行工具体验，您也可以在[ :rocket:  阿里云 CloudShell](https://api.aliyun.com/new#/tutorial?action=git_open&git_repo=https://github.com/devsapp/start-web-framework.git&tutorial=web-framework/website/hexo/cloudshell.md) 中快速体验。
# 应用详情

本项目是将非常流行文档框架 `hexo`，部署到阿里云 Serverless 平台（函数计算 FC）。
